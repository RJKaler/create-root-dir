...
#This is a basic script that will create a root file system on Ubuntu or other distros. To make this work, you first have to enable root. You can do that simply with sudo passwd root. Root will come with default sys files like /etc/ /sys /mnt 
